...
const topics: Topic[] = [
  ...
  { slug: 'filipino-virtual-assistant-proposal-preparation', title: 'A safe proposal-preparation workflow for Filipino assistants', focus: 'proposal preparation', outcome: 'complete drafts ready for owner review', tasks: 'assemble approved details, check required fields, and list open questions', boundary: 'scope, legal language, and commercial promises', published: '2026-08-12' },
